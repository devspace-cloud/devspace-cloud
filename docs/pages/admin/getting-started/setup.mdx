...
:::warning Use loft instead
Our new product [loft](https://loft.sh) is the v2 of DevSpace Cloud on-premise. Please see [www.loft.sh](https://loft.sh) for details.

loft is similar to DevSpace Cloud on-premise but more powerful because it provides integrations with external auth providers, provides CRDs for spaces/clusters/users etc. and even allows you to create virtual Kubernetes clusters.
:::
